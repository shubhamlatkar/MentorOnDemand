package com.mod.user_service.security;

import com.mod.user_service.security.config.CORSFilter;
import com.mod.user_service.security.config.PasswordConfig;
import com.mod.user_service.security.jwt.JwtReqFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/user/trainer/**", "/user/swagger-ui/**", "/user/swagger-ui.html", "/user/v3/api-docs/**").permitAll()
                .anyRequest()
                .authenticated()
                .and()
